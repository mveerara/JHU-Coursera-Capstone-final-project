...
makeNgrams <- function(x, ngram = 2L, markSentences = F,
  ...
  require(tau)
  source('E:/Mukund back up June 2017/mukund files/MUKUND BACKUP/My learning/Coursera Data scientist/10 - Capstone project - Text mining NLP/Other example capstone project/Thiele/getSkipNgrams.R')
  punct <- '[]\\?!\"#$%&(){}+*:;,._`|~\\[\\=\\@\\^-]'
